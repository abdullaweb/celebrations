                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" name="product_name" id="product_name" class="form-control"
                                        ...
                                        data-parsley-required-message="Purchase Product is required" value="{{$purchaseInfo->product_name}}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" name="product_qty" class="form-control product_qty"
                                        ...
                                        data-parsley-required-message="Purchase Quantity is required" value="{{$purchaseInfo->product_qty}}" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" name="product_price" class="form-control product_price"
                                        ...
                                        data-parsley-trigger="keyup" data-parsley-validation-threshold="0"
                                        data-parsley-type="number" data-parsley-type-message="Input must be positive number"
                                        data-parsley-required-message="Product Price is required" value="{{$purchaseInfo->product_price}}" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" name="total_amount" class="form-control total_amount"
                                        ...
                                        data-parsley-trigger="keyup" data-parsley-validation-threshold="0"
                                        data-parsley-type="number" data-parsley-type-message="Input must be positive number"
                                        data-parsley-required-message="Purchase Amount is required" value="{{$purchaseInfo->total_amount}}" />
                                </div>
                            </div>
                            <div class="row">
